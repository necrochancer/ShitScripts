...
local function FartHubLoad()
	...
	local GUI = Rayfield:CreateWindow({
		...
		KeySettings = {
			...
			Key = { "fart" }, -- this is very protected trust 😭
		},
	})
	...
	local function InitializeGUI()
		...
		-- Visuals Tab
		local VisualsSection = VisualsTab:CreateLabel("Highlights for things.")
		...
		-- Player Tab
		local PlayerSection = PlayerTab:CreateLabel("Player Stuff.")
		...
		-- Generator Tab
		local GeneratorSection = GeneratorTab:CreateLabel("Uh stuff that does sm to generators.")
		...
		-- Blatant Tab
		local BlatantSection = BlatantTab:CreateLabel("Stuff that might get you banned if ur obvious")
		...
		-- Misc Tab
		local MiscTitle = MiscTab:CreateLabel("Stuff that i didnt know where to put")
