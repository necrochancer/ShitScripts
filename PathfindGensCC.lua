...
if queueteleport then queueteleport("if getgenv then getgenv().DiscordWebhook = " .. tostring(DCWebhook) .. " end " .. "loadstring(game:HttpGet('https://raw.githubusercontent.com/ivannetta/ShitScripts/main/PathfindGensCC.lua'))()") end
